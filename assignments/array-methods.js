...
let fullName = [];
let newName = runners.forEach(function(runner) {
...
// Problem 1: Get runners with odd ID numbers


// Problem 2: Get runners with emails starting with a
let mediumShirts = runners.filter((runner) => runner.shirt_size == "M")
console.log(mediumShirts);

// Problem 3: Get a list of companies and email
let companyAndEmail = runners.map((runner) => {
    return runner.company_name + ' ' + runner.email;
});
console.log(companyAndEmail);